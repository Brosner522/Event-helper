...
Event.create(name: "Software Seminar", date: Faker::Date.between(from: '2021-09-23', to: '2022-12-25'), time: "9:30 am", location: "4 W 43rd St, New York, NY 10036", price: rand(20..100), description: "The Software Seminar is a yearly event to give our community a chance to gather and discuss the new technologies that become available to us.", img: "https://breezy-gallery.imgix.net/f8301/Image%20from%20iOS%206%201.jpg")

Event.create(name: "The Stackholm Invitational", date: Faker::Date.between(from: '2021-09-23', to: '2022-12-25'), time: "11:00 am", location: "Great Lawn Oval, New York, NY 10024", price: rand(20..100), description: "Just a group of Flatiron students balling out together.", img: "https://nodawaynews.com/wp-content/uploads/2019/11/Screen-Shot-2019-11-27-at-5.13.09-PM.png")
